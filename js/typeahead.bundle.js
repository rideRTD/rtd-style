 ...
 *
 *  NOTE: This script includes the following customizations:
 *          - to WAI-ARIA combobox support
 *          - Support for "Updated" custom event which passes the top suggestion
 *
 */
...
(function($) {
            ...
            _render: function render(query, suggestions) {
                ...
                function getSuggestionsHtml() {
                    ...
                    function getSuggestionNode(suggestion, i) {
                        var $el;
                        $el = $(html.suggestion).append(that.templates.suggestion(suggestion)).data(datasetKey, that.name).data(valueKey, that.displayFn(suggestion)).data(datumKey, suggestion).attr("id", listboxId + i);
    ...
    var Dropdown = function() {
        ...
        _.mixin(Dropdown.prototype, EventEmitter, {
            ...
            getSuggestionCount: function getSuggestionCount() {
                return this._getSuggestions().length;
            },
            updateStatus: function updateStatus() {
                var count = this.getSuggestionCount();
                this.$status.text(count + ' items');
            },
            clearStatus: function clearStatus() {
                this.$status.text('0 items');
            },
    ...
    var Typeahead = function() {
        ...
        function Typeahead(o) {
            ...
            $status = this.$node.find(".tt-status");
        ...
        _.mixin(Typeahead.prototype, {
            ...
            _updateHint: function updateHint() {
                ...
                if (datum && this.dropdown.isVisible() && !this.input.hasOverflow()) {
                    ...
                    this.eventBus.trigger("updated", datum ? datum.raw : null);
                } else {
                    this.input.clearHint();
                }
            },
        ...
        function buildDom(input, withHint) {
            var $input, $wrapper, $dropdown, $hint, $status, listboxId;
            $input = $(input);
            $wrapper = $(html.wrapper).css(css.wrapper);
            $dropdown = $(html.dropdown).css(css.dropdown);
            $hint = $input.clone().css(css.hint).css(getBackgroundStyles($input));
            $status = $(html.status).css(css.status);
            ...
            return $input.wrap($wrapper).parent().prepend(withHint ? $hint : null).append($dropdown).append($status);
        }
