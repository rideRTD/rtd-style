...
;(function(window) {
    ...
    DrawerMenu.prototype = {
        ...
        _init: function() {
            ...
            _this.$triggers = $('#' + _this.options.menuTriggerID + ', #' + _this.options.toolsTriggerID);
                ...
                if (theNavLevel.is(':visible')) {
                    ...
                    if (_this.options.accordion === true) {
                        if (_this.$navLevels.is(':visible')) {
                            ...
                            var otherLevels = _this.$navLevels.not(theNavLevel).not(theNavLevel.parents('.' + _this.options.navLevelsClass));
        ...
        _removeEvents: function() {
            var _this = this;
            _this.$toolsTrigger
            .add(_this.$menuTrigger)
                .off(_this.triggerevents);
            _this.$navBtn
                .off(_this.navevents);
        },
        ...
        _initAria: function() {
            ...
            _this.$menuTrigger
                .attr('aria-controls', _this.options.menuID);
            _this.$toolsTrigger
                .attr('aria-controls', _this.options.toolsID);
            _this.$navBtn
                .attr('aria-expanded', 'false')
                .attr('aria-controls', function() {
                    return $(this).next('.' + _this.options.navLevelsClass).attr('id');
                });
        ...
        _toggleTools: function() {
            ...
            if (_this.$toolsTrigger.attr('aria-expanded') === 'false' && typeof ga !== 'undefined') {
            ...
            if (_this.$menu.is(':visible')) {
                _this.$menu
                    .slideToggle(400)
                    .attr('aria-hidden', function(i, val) {
                        return val === 'true' ? 'false' : 'true';
                    });
