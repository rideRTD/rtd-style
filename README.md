...
- Tag your commit with an incremental version change (e.g. v0.5.4).
- Update the dependency in each project's package.json (e.g. git+https://github.com/rideRTD/rtd-style.git#v0.5.4)
